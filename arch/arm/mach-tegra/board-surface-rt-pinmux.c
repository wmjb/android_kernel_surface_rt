...
static __initdata struct tegra_pingroup_config surface_rt_pinmux_common[] = {
	...
	DEFAULT_PINMUX(GPIO_PV1,        RSVD1,  NORMAL,    TRISTATE,         INPUT),
	...
	DEFAULT_PINMUX(GPIO_PV3,        INVALID,  NORMAL,    TRISTATE,       INPUT),
	...
	DEFAULT_PINMUX(VI_D0,           INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D1,           INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D2,           INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D3,           INVALID,  NORMAL,    TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D4,           INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D5,           INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D6,           INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D7,           INVALID, NORMAL,    NORMAL,       OUTPUT),
	DEFAULT_PINMUX(VI_D8,           INVALID, NORMAL,    NORMAL,       OUTPUT),
	DEFAULT_PINMUX(VI_D9,           INVALID, NORMAL,    NORMAL,       OUTPUT),
	DEFAULT_PINMUX(VI_D10,          INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_D11,          INVALID,  NORMAL,    NORMAL,       INPUT),
	DEFAULT_PINMUX(VI_PCLK,         RSVD1,  PULL_DOWN, TRISTATE,         INPUT),
	DEFAULT_PINMUX(VI_MCLK,         INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_VSYNC,        INVALID,  PULL_DOWN, TRISTATE,       INPUT),
	DEFAULT_PINMUX(VI_HSYNC,        INVALID, NORMAL,    NORMAL,       OUTPUT),
	...
	DEFAULT_PINMUX(CORE_PWR_REQ,    RSVD1,  NORMAL,    NORMAL,         INPUT),
	DEFAULT_PINMUX(CPU_PWR_REQ,     RSVD1,  NORMAL,    NORMAL,         INPUT),
	DEFAULT_PINMUX(PWR_INT_N,       RSVD1,  NORMAL,    NORMAL,         INPUT),
	DEFAULT_PINMUX(CLK_32K_IN,      RSVD1,  NORMAL,    NORMAL,         INPUT),
	...
	DEFAULT_PINMUX(SPI2_CS1_N,      INVALID,  PULL_UP,   NORMAL,       INPUT),
	DEFAULT_PINMUX(SPI2_CS2_N,      INVALID,  NORMAL,    NORMAL,       INPUT),
