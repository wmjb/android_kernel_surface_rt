...
static __initdata struct tegra_pingroup_config surface_rt_pinmux_common[] = {
	...
	DEFAULT_PINMUX(GPIO_PV3,        RSVD,  NORMAL,    TRISTATE,       INPUT),
	...
	DEFAULT_PINMUX(VI_MCLK,         RSVD1,  PULL_DOWN, TRISTATE,       INPUT),
	...
	DEFAULT_PINMUX(CORE_PWR_REQ,    RSVD2,  NORMAL,    NORMAL,         INPUT),
	DEFAULT_PINMUX(CPU_PWR_REQ,     RSVD2,  NORMAL,    NORMAL,         INPUT),
	DEFAULT_PINMUX(PWR_INT_N,       RSVD2,  NORMAL,    NORMAL,         INPUT),
	DEFAULT_PINMUX(CLK_32K_IN,      RSVD2,  NORMAL,    NORMAL,         INPUT),
	...
	DEFAULT_PINMUX(SPI2_CS1_N,      RSVD,  PULL_UP,   NORMAL,       INPUT),
