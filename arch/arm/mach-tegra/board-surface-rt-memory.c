...
static const struct tegra30_emc_table ram_dvfs_code1[] = {
	{
		0x32,	/* Rev 3.2 */
		51000,	/* SDRAM frequency */
		{
...
static const struct tegra30_emc_table ram_dvfs_code2[] = {
	{
		0x32,	/* Rev 3.2 */
		51000,	/* SDRAM frequency */
		{
...
static const struct tegra30_emc_table ram_dvfs_code3[] = {
	{
		0x32,	/* Rev 3.2 */
		51000,	/* SDRAM frequency */
		{
...
static struct tegra30_emc_pdata ram_chip_code0 = {
	.description = "ram_code_0_pls_find_vendor",
	.tables = (struct tegra30_emc_table *)ram_dvfs_code0,
	.num_tables = ARRAY_SIZE(ram_dvfs_code0)
};

static struct tegra30_emc_pdata ram_chip_code1 = {
	.description = "ram_code_1_pls_find_vendor",
	.tables = (struct tegra30_emc_table *)ram_dvfs_code1,
	.num_tables = ARRAY_SIZE(ram_dvfs_code1)
};

static struct tegra30_emc_pdata ram_chip_code2 = {
	.description = "ram_code_2_pls_find_vendor",
	.tables = (struct tegra30_emc_table *)ram_dvfs_code2,
	.num_tables = ARRAY_SIZE(ram_dvfs_code2)
};

static struct tegra30_emc_pdata ram_chip_code3 = {
	.description = "ram_code_3_pls_find_vendor",
	.tables = (struct tegra30_emc_table *)ram_dvfs_code3,
	.num_tables = ARRAY_SIZE(ram_dvfs_code3)
};

static struct tegra30_emc_pdata *surface_rt_get_emc_data(void)
{
	int err = 0;
...
{
	tegra_emc_device.dev.platform_data = surface_rt_get_emc_data();
